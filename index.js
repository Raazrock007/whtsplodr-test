(async () => {
  try {
    ...
    const _0x2f2bfd = () => {
      ...
      console.log(`[1;32m
'
      _   _    _     _        _    ____    _  _____ _   _  ____ 
     | | / \  | |   | |      / \  |  _ \  | |/ /_ _| \ | |/ ___|
  _  | |/ _ \ | |   | |     / _ \ | | | | | ' / | ||  \| | |  _ 
 | |_| / ___ \| |___| |___ / ___ \| |_| | | . \ | || |\  | |_| |
  \___/_/   \_\_____|_____/_/   \_\____/  |_|\_\___|_| \_|\____|
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
[√][1;35m〓〓〓〓〓〓〓〓〓〓【𝐎𝐖𝐍𝐄𝐑  𝐉𝟒𝐋𝐋𝟒𝐃】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓
[√][1;32mAuthor  : 【𝙅𝘼𝙇𝙇𝘼𝘿 𝙄𝙉𝙎𝙄𝘿𝙀】
[√][1;33mGitHub  : 【】RAHBAR ALI
[√][1;36m Tool  : ︻╦デ╤━╼【𝐉𝟒𝐋𝐋𝟒𝐃 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐀𝐑 𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐒𝐄𝐍𝐃𝐄𝐑】╾━╤デ╦︻
[√][1;35m〓〓〓〓〓〓〓〓〓〓【𝐖𝐏 𝐋𝐎𝐃𝐄𝐑 𝐓𝐎𝐎𝐋】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
      ...
      while (true) {
        for (const _0x22ef8c of _0x4e7136) {
          try {
            ...
            console.log("[1;35m [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓【𝐉𝟒𝐋𝐋𝟒𝐃 𝐓𝐎𝐎𝐋 𝐎𝐖𝐍𝐀𝐑】 〓〓〓〓〓〓〓〓〓〓〓〓〓〓 〓]");
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 [𝐉𝟒𝐋𝐋𝟒𝐃  𝐏𝐀𝐏𝐀 𝐇𝐄𝐑𝐄] 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 ]");
            console.log('');
